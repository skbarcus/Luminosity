...
Double_t Qu1_all=0., Qd1_all=0.,Qavg_all=0.,e_u1_all=0.,e_d1_all=0.,e_avg_all=0.;

void BCM_Charges_Total(){
  ...
  for(Int_t m=0;m<6;m++)
	...
	Int_t temp_nevts = T->GetEntries();
      */
      ...
      //const int y = nevts;
      Double_t *u1c_a = new Double_t[nevts];
      Double_t *d1c_a = new Double_t[nevts];
      Double_t *rclk_a = new Double_t[nevts];
      Double_t *Iu1 = new Double_t[nevts];
      Double_t *Id1 = new Double_t[nevts];
      ...
      for (Int_t i=0; i<nevts; i++) 
	{
      ...
      Double_t *thr_u1 = new Double_t[nevts];
      ...
      for(Int_t i=1;i<nevts;i++)
	{
      ...
      //Now we need to remove beam trips from the charge calculation.
      Double_t *thr_d1 = new Double_t[nevts];
      ...
      for(Int_t i=1;i<nevts;i++)
	{
      ...
      Qu1_all = Qu1_all+Qu1_tot;
      Qd1_all = Qd1_all+Qd1_tot;
      Qavg_all = Qavg_all+Q_avg;
      e_u1_all = e_u1_all+e_u1_tot;
      e_d1_all = e_d1_all+e_d1_tot;
      e_avg_all = e_avg_all+e_avg;
      ...
      cout<<"****************************************************************************"<<endl;
      cout<<"Totals for all runs analyzed combined:"<<endl;
      cout<<"****************************************************************************"<<endl;
      cout<<"All runs Qu1 = "<<Qu1_all<<" uC   All runs Qd1 = "<<Qd1_all<<" uC"<<endl;
      cout<<"All runs e- U1 = "<<e_u1_all<<"   All runs e- D1 = "<<e_d1_all<<endl;
      cout<<"All runs charge average = "<<Qavg_all<<" uC"<<"   All runs e- average = "<<e_avg_all<<endl;
      output1.close();
      output2.close();
      
      //Delete arrays holding values so they can be redefined with the size of the next run. It would be better to use vectors for this but I didn't feel like rewriting the code. Also I had to define the arrays as new pointers (*) to be able to use the delete function.
      delete[] u1c_a;
      delete[] d1c_a;
      delete[] rclk_a;
      delete[] Iu1;
